...
public class Test {
	...
	public static void main(String[] args) {
		...
		Bicicleta bici2 = new Bicicleta("mitsubishi", "ladetumama", 10);
		Bicicleta bici3 = new Bicicleta("mitsubishi", "ladetumama", 2010);
		Bicicleta bici4 = new Bicicleta("mitsubishi", "ladetumama", 2001);
		Bicicleta bici5 = new BiciElectrica("mitsubishi", "ladetumama", 230, 1500);
		Bicicleta bici6 = new BiciElectrica("mitsubishi", "ladetumama", 240, 1800);
		Bicicleta bici7 = new BiciElectrica("mitsubishi", "ladetumama", 250, 1999);
		Bicicleta bici8 = new BiciElectrica("mitsubishi", "ladetumama", 260, 2000);
